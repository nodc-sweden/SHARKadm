            ...
            if len(uncertainties) == 3:
                if (
                    ...
                    if prior_endpoint == "yes":
                        ...
                        bool_range_high = param_vals >= uncertainties["limit"][2]
                    uncert_vals[bool_range_low] = self._get_uncert(
                        param_vals[bool_range_low],
                        unit,
                        uncertainties["unc"][0],
                        str(uncertainties["unc_unit"][0]),
                    )
                    uncert_vals[bool_range_middle] = self._get_uncert(
                        param_vals[bool_range_middle],
                        unit,
                        uncertainties["unc"][1],
                        str(uncertainties["unc_unit"][1]),
                    )
                    uncert_vals[bool_range_high] = self._get_uncert(
                        param_vals[bool_range_high],
                        unit,
                        uncertainties["unc"][2],
                ...
                if (
                    ...
                    uncert_vals.loc[bool_range_low] = self._get_uncert(
                        param_vals[bool_range_low],
                        unit,
                        uncertainties["unc"][0],
                        str(uncertainties["unc_unit"][0]),
                ...
                if "unc_unit" not in uncertainties.columns:
                    uncert_vals = self._get_uncert(
                        param_vals, unit, uncertainties["unc"][0], ""
                    )
                else:
                    uncert_vals = self._get_uncert(
                        param_vals,
                        unit,
                        str(uncertainties["unc"][0]),
