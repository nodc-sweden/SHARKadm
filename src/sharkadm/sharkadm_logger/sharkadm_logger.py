...
class SHARKadmLogger:
    ...
    def log_workflow(self,
        ...
        data = dict(log_type=self.WORKFLOW, msg=msg, level=level, cls=cls, item=item, purpose=purpose)
        self._log(**data)
    ...
    def log_transformation(self,
        ...
        if stack[1][0].f_locals.get('self'):
            cls = stack[1][0].f_locals["self"].__class__.__name__
        data = dict(log_type=self.TRANSFORMATION, msg=msg, level=level, cls=cls, item=item, purpose=purpose, row_number=row_number)
        self._log(**data)
    ...
    def log_validation(self,
        ...
        if stack[1][0].f_locals.get('self'):
            cls = stack[1][0].f_locals["self"].__class__.__name__
        data = dict(log_type=self.VALIDATION, msg=msg, level=level, cls=cls, item=item, purpose=purpose, row_number=row_number)
        self._log(**data)
    ...
    def log_export(self,
        ...
        if stack[1][0].f_locals.get('self'):
            cls = stack[1][0].f_locals["self"].__class__.__name__
        data = dict(log_type=self.EXPORT, msg=msg, level=level, cls=cls, item=item, purpose=purpose)
        self._log(**data)
...
class old_SHARKadmLogger:
    ...
    def log_workflow(self,
        ...
        if stack[1][0].f_locals.get('self'):
            cls = stack[1][0].f_locals["self"].__class__.__name__
        data = dict(log_type=self.WORKFLOW, msg=msg, level=level, cls=cls, item=add, purpose=purpose)
        self.log(**data)
    ...
    def log_transformation(self,
        ...
        if stack[1][0].f_locals.get('self'):
            cls = stack[1][0].f_locals["self"].__class__.__name__
        data = dict(log_type=self.TRANSFORMATION, msg=msg, level=level, cls=cls, item=add, purpose=purpose, row_number=row_number)
        self.log(**data)
    ...
    def log_validation(self,
        ...
        if stack[1][0].f_locals.get('self'):
            cls = stack[1][0].f_locals["self"].__class__.__name__
        data = dict(log_type=self.VALIDATION, msg=msg, level=level, cls=cls, item=add, purpose=purpose, row_number=row_number)
        self.log(**data)
    ...
    def log_export(self,
        ...
        if stack[1][0].f_locals.get('self'):
            cls = stack[1][0].f_locals["self"].__class__.__name__
        data = dict(log_type=self.EXPORT, msg=msg, level=level, cls=cls, item=add, purpose=purpose)
        self.log(**data)
