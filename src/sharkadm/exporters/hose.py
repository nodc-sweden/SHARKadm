...
class ExportHoseRowsFromLimsExport(PolarsFileExporter):
    ...
    def get_exporter_description() -> str:
        return "Creates a LIMS hose txt file"

    def _export(self, data_holder: PolarsDataHolder) -> None:
        if not self._export_file_name:
            self._export_file_name = f"data_hose_{data_holder.dataset_name}.txt"
