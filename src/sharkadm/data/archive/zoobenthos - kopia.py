...
class ZoobenthosArchiveDataHolder(ArchiveDataHolder):
    ...
    def _add_data_sources(self) -> None:
        for name, path in self._file_paths.items():
            ...
            d_source.add_concatenated_column(
                "visit_key", ["visit_date", "reported_station_name"]
            )
            if name in [
                "sample",
                "abundance",
                ...
                d_source.add_concatenated_column(
                    "sample_key", ["visit_date", "reported_station_name", "sample_id"]
                )
    ...
    def _merge_files_origin_txt(self):
        ...
        sediment_data = self._get_data_from_data_source(
            self._file_data["dataSedimentfarg"]
        )
