...
from sharkadm.transformers.add_density import PolarsAddDensityLong, PolarsAddDensityWide
...
@patch("sharkadm.config.get_all_data_types", return_value=[])
def test_validate_add_density_long(
    mock_get_all_data_types,
    polars_data_frame_holder_class,
    given_visit_key,
    given_latitude,
    ...
    # Transforming the data
    PolarsAddDensityLong().transform(given_data_holder)
