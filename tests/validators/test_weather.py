...
@pytest.mark.parametrize(
    "given_visit_date, given_station, given_weather_observation_code, expected_success",
    (
...
@pytest.mark.parametrize(
    "given_visit_date, given_station, given_weather_observation_code, "
    "given_cloud_observation_code, expected_success",
    (
        ("20230802", "SKÅPESUND", "0", "0", True),
        ("20230802", "SKÅPESUND", "0", "1", False),
        ("20230802", "SKÅPESUND", "0", "8", False),
        ("20230802", "SKÅPESUND", "0", "9", True),
        ("20230530", "SMÅHOLMARNA", "1", "0", False),
        ("20230530", "SMÅHOLMARNA", "1", "1", True),
        ("20230530", "SMÅHOLMARNA", "1", "6", True),
        ("20230530", "SMÅHOLMARNA", "1", "7", False),
        ("20230530", "SMÅHOLMARNA", "1", "8", False),
        ("20230530", "SMÅHOLMARNA", "1", "9", True),
        ("20230802", "SKÅPESUND", "2", "1", False),
        ("20230802", "SKÅPESUND", "2", "6", False),
        ("20230802", "SKÅPESUND", "2", "7", True),
        ("20230802", "SKÅPESUND", "2", "8", True),
        ("20230802", "SKÅPESUND", "2", "9", True),
        ("20230530", "SVENSHOLMEN", "2.0", "8", True),  # Float
        ("20230530", "SVENSHOLMEN", "2", "7.0", True),  # Float
        ("20230802", "SKÅPESUND", "0", "07", False),  # Zeropadded, cast to int
        ("20230802", "SKÅPESUND", "01", "07", False),  # Zeropadded, cast to int
        ("20230802", "SKÅPESUND", "", "1", True),  # Missing as str
        ("20230802", "SKÅPESUND", "2", None, True),  # Missing as None
        ("20230802", "SKÅPESUND", " ", "1", True),  # White space
    ),
)
@patch("sharkadm.config.get_all_data_types")
